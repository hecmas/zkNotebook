...
function verify(PK, msg, SIG) {
    const h = hash_to_G1_mock(msg);
    const nh = parameters_1.E.neg(h);
    // e(SIG, G2) = e(h, PK) <==> e(SIG, G2) · e(-h, PK) = 1
    return (0, optimal_ate_pairing_1.verify_pairing_identity)([SIG, nh], [parameters_1.G2, PK]);
...
function verify_multiple(PKs, msgs, SIGs) {
    ...
    const nASIG = parameters_1.E.neg(aSIG);
    // e(aSIG,G2) = e(h1,PK1) · e(h2,PK2) · e(h3,PK3) <==> e(-aSIG,G2) · e(h1,PK1) · e(h2,PK2) · e(h3,PK3) = 1
    return (0, optimal_ate_pairing_1.verify_pairing_identity)([nASIG, ...hashes], [parameters_1.G2, ...PKs]);
...
function verify_multiple_one_message(PKs, msg, SIGs) {
    ...
    return (0, optimal_ate_pairing_1.verify_pairing_identity)([nASIG, h], [parameters_1.G2, aPK]);
    // const lhs = optimal_ate_bn254(aSIG, G2);
