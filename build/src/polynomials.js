...
exports.squareAndMultiply = exports.egcd = exports.euclidean_division = exports.degree = exports.RingOfPolynomials = void 0;
const primeField_1 = require("./primeField");
/*
    A polynomial p(x) = a0 + a1·x + a2·x^2 + ... + an·x^n  is represented
    by the array [a0, a1, a2, ..., an].
 */
class RingOfPolynomials {
    Fp;
    // Constructor
    constructor(p) {
...
exports.RingOfPolynomials = RingOfPolynomials;
function degree(a) {
    let d = a.length - 1;
    while (d && a[d] === 0n) {
        d--;
